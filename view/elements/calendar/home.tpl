			...
			<form class="form-horizontal">
			  ...
			  <div class="modal-body">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  <select name="color" class="form-control" id="color_add">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  <input type="datetime-local" name="start" class="form-control" id="start_add">
					</div>
				  </div>
				  <div class="form-group">
					<label for="end" class="col-sm-2 control-label">End date</label>
					<div class="col-sm-10">
					  <input type="datetime-local" name="end" class="form-control" id="end_add">
					</div>
				  </div>
			...
			<form class="form-horizontal">
			  ...
			  <div class="modal-body">
				  ...
				  <div class="form-group">
					<label for="color" class="col-sm-2 control-label">Color</label>
					<div class="col-sm-10">
					  <select name="color" class="form-control" id="color_edit">
						  <option value="">Choose</option>
						  <option style="color:#0071c5;" value="#0071c5">&#9724; Dark blue</option>
						  <option style="color:#40E0D0;" value="#40E0D0">&#9724; Turquoise</option>
						  <option style="color:#008000;" value="#008000">&#9724; Green</option>						  
...
$(document).ready(function() {
		...
		$("button.addEvents").click(function(){

			var title 	= $('input#title_add').val();
			var color 	= $('select#color_add').val();
			var start 	= $('input#start_add').val();
			var end 	= $('input#end_add').val();

			$.ajax({
			type: "POST",
			dataType: "json",
			url: "index.php?mod=cale&op=add_event",
	...
	$("button.editEvents").click(function(){
			...
			var edit_start 	= $('input#start_edit').val();
